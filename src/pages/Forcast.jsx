...
import firstVids from '../comp/projImg/weatherVid.mp4'
...
//shorts img
import shortOne from '../comp/projImg/weatherApp.JPG'
import shortTwo from '../comp/projImg//weatherControl.JPG'
import shortThree from '../comp/projImg//secWeather.JPG'
//long img
import city from '../comp/projImg/city.JPG'
//absoImg
    ...
    <div className='frst'>
      ...
      <div className='secPageCon'>
        <div className='firstPageDesc'>
          Forcast is not just another weather app; it's your personal meteorological oracle. Crafted with the precision and aesthetics befitting a modern frontend developer, Forcast seamlessly blends functionality with style to bring you the most intuitive weather experience.
        </div>
      ...
      <div className='cred'>
        ...
        <div className='live' onClick={() => {
          window.open('https://forcast-dev.netlify.app/', '')
        }}>
