...
import firstVids from '../comp/projImg/pixieVid.mp4'
...
//shorts img
import shortOne from '../comp/projImg/pixieone.JPG'
import shortTwo from '../comp/projImg//pixietwo.JPG'
import shortThree from '../comp/projImg//pixiethree.JPG'
//long img
import longImgs from '../comp/projImg/pixielong.jpg'
//absoImg
...
const PixieShop = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0)
    document.title = "PIXIE SHOP | CONTENT"
    ...
    <div className='frst'>
      ...
      <div className='secPageCon'>
        <div className='firstPageDesc'>
          Pixie Shop is an exciting e-commerce website that showcases my skills in web development and design. This project represents my passion for creating visually appealing and user-friendly online shopping experiences.
        </div>
      ...
      <div className='cred'>
        ...
        <div className='live' onClick={() => {
          window.open('https://marcusxro.github.io/Ecommerce/', '')
        }}>
